<template>
  <header>
    <div class="flex items-center justify-between p-2 bg-white shadow-sm m-6 rounded-lg">
      ...
      <div class="flex items-center space-x-4">
        <button class="relative p-2 text-gray-400 hover:text-gray-500">
          <v-icon size="28">mdi-bell</v-icon> <!-- Notification Icon -->
        ...
        <button class="p-2 text-gray-400 hover:text-gray-500">
          <v-icon size="28">mdi-cog</v-icon> <!-- Settings Icon -->
        </button>
